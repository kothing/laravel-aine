<template>
    <div class="admin__project-content-edit relative h-full flex flex-col">
            ...
            <div class="w-9/12 p-4 overflow-x-auto">
                <div class="mb-2 py-2 font-bold text-lg flex justify-between">
                    ...
                    <div class="flex">
                        ...
                        <ui-button v-if="content.published_at === null" :color="'green-500'" class="rounded-r-none ml-2" @click.native="saveEdit(true)">Save and Publish</ui-button>
                            ...
                            <div v-for="field in collection.fields" :key="field.id" :class="`field-${field.type}`">
                                ...
                                <div class="mt-1 relative">
                                    ...
                                    <div v-if="field.type == 'richtext'" class="field-type-richtext relative">
                                        <tiny-editor
                                            :value="newData.data[field.name]"
                                            :placeholder="field.placeholder"
                                            height="320px"
                                            :editor-id="'tinyEditor_' + field.name"
                                            @input="newData.data[field.name] = $event"
                                        />
                                    ...
                                    <div v-if="field.type == 'relation'" class="field-type-relation w-full">
                                        <div class="w-full border rounded-md p-2">
                                            ...
                                            >
                                                ...
                                                Select relation ({{ field.options.relation.type == 1 ? "One to One" : "One to Many" }})
                                            </div>
                    ...
                    <div class="col-span-2 mt-2 ml-2">
                            ...
                            <div class="p-5">
                                <p class="text-sm text-red-600 mt-1">
                                    <span v-if="Object.keys(newData.errors).length === 1">
                                        {{ Object.keys(newData.errors).length }}
                        ...
                        <div class="bg-white mb-2 rounded-md" v-if="content.published_at !== null">
                            <div
                                ...
                                @click="unpublish()"
                            >
                                <i class="fa fa-pencil-ruler"></i> Mark as Draft
                            </div>
                        </div>
                        <div class="bg-white mb-2 rounded-md">
                            <div
                            ...
                            >
                                <i class="fa fa-trash-restore"></i> Move to Trash
                            </div>
                        </div>
                        <div class="bg-white mb-2 rounded-md">
                            <div
        ...
        <ui-modal maxWidth="7xl" :show="openRelationModal" @close="closeRelationModal">
            <template #title> Select Relation ({{ relationModalCollectionTYPE == 1 ? "One to One" : "One to Many" }}) </template>
...
export default {
    ...
    methods: {
        ...
        saveEdit(published, after = null) {
            ...
            axios.post("/admin/content/update/" + this.$route.params.project_id + "/" + this.$route.params.col_id + "/" + this.$route.params.content_id, this.newData).then(
                (response) => {
        ...
        removeRelation(item, field_name) {
            ...
            for (let i = 0; i < this.relationRecords[field_name].length; i++) {
                ...
                if (element.id == item.id) this.$delete(this.relationRecords[field_name], i);
            }
            this.$forceUpdate();
        },
