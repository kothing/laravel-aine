                    ...
                    <div class="flex">
                        ...
                        <div class="flex border-indigo-600 border border-l-1 border-t-0 border-b-0 border-r-0">
                            <ui-dropdown align="right">
                                ...
                                <template #content>
                                    <ui-button type="button" color="white" hover="gray-200" class="w-full h-full an__rounded-b-none" @click.native="saveNew(false, 'close')">
                                        <div class="text-gray-600 text-sm text-left">Save and close</div>
                                    </ui-button>
                                    <ui-button type="button" color="white" hover="gray-200" class="w-full h-full an__rounded-t-none" @click.native="saveNew(false, 'new')">
                        ...
                        <div class="flex border-green-600 border border-l-1 border-t-0 border-b-0 border-r-0">
                            <ui-dropdown align="right" width="60">
                                ...
                                <template #content>
                                    <ui-button type="button" color="white" hover="gray-200" class="w-full h-full an__rounded-b-none" @click.native="saveNew(true, 'close')">
                                        <div class="text-gray-600 text-sm text-left">Save, publish and close</div>
                                    </ui-button>
                                    <ui-button type="button" color="white" hover="gray-200" class="w-full h-full an__rounded-t-none" @click.native="saveNew(true, 'new')">
...
export default {
    ...
    methods: {
        ...
        saveNew(published, after = null) {
            ...
            axios.post("/admin/content/store/" + this.$route.params.project_id + "/" + this.$route.params.col_id, this.newData).then(
                (response) => {
        ...
        async insertFiles(files) {
            await axios
                .post("/admin/content/get-selected-files/" + this.$route.params.project_id, {
                    data: files,
                })
                .then((response) => {
        ...
        async addSelectedRelation(data) {
            ...
            await axios
                .post("/admin/content/get-selected-records/" + this.$route.params.project_id, {
                    data: data,
                })
                .then((response) => {
