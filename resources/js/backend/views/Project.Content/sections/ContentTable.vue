    ...
    <div class="admin__project-content-table">
        ...
        <div class="w-full flex justify-between text-sm text-gray-700 mb-2 pl-1">
            <div class="flex">
                ...
                >
                    <i class="fa fa-cloud-upload-alt"></i> publish
                </div>
                <div
                    v-if="selected.length !== 0 && listOptions.getItems !== 'trashed'"
                ...
                >
                    <i class="fa fa-cloud-download-alt"></i> unpublish
                </div>
                <div
                    v-if="selected.length !== 0 && listOptions.getItems !== 'trashed'"
    ...
    methods: {
        ...
        setInitialColumns() {
            ...
            this.collection.fields.forEach((field) => {
                if (field.options.hideInContentList) Vue.set(this.columns, field.name, false);
