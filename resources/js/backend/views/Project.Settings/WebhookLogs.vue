                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {{ log.created_at | date("D MMM YYYY, H:mm") }}
                                            </td>
                                            <td
                                                class="px-6 py-3 text-sm whitespace-nowrap"
                                            >
...
export default {
    ...
    methods: {
        getProject(page) {
            ...
            axios
                .get(
                    "/admin/projects/settings/webhooks/" + this.$route.params.project_id + "/logs/" + this.$route.params.webhook_id + "?page=" + page
                )
                .then((response) => {
            ...
            this.$swal
                ...
                .then((result) => {
                    if (result.value) {
                        axios
                            .delete(
                                "/admin/projects/settings/webhooks/" + this.$route.params.project_id + "/logs/" + this.$route.params.webhook_id
                            )
                            .then((response) => {
                                this.$toast.success(
