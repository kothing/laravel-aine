                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        >
                                            <ui-button
                                                color="indigo-500"
                                                @click.native="assignUser('editor')"
                                            >
                                                + Assign User
                                            </ui-button>
                                        </td>
        ...
        <ui-modal :show="openAssignUserModal" @close="closeAssignUserModal">
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        <ui-button
                            color="indigo-500"
                            v-if="!createNewUser"
                            @click.native="createNewUser = true"
                        >
                            Create New User
                        </ui-button>
                        <ui-button
                            color="green-500"
                            v-if="createNewUser"
                            @click.native="createNewUser = false"
                        >
            ...
            <template #footer>
                ...
                <ui-button
                    color="indigo-500"
                    v-if="createNewUser"
                    @click.native="createNewUserSubmit"
                >
                    Create User
                </ui-button>
            </template>
...
export default {
    ...
    methods: {
        getProject() {
            axios
                .get(
                    "/admin/projects/settings/users/" + this.$route.params.project_id
                )
                .then((response) => {
