    ...
    <div class="admin__project-collection-list relative h-full flex flex-col">
                        ...
                        <div class="mt-6" v-if="current_field_type == 'slug'">
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">
                                    ...
                                    <strong>text fields</strong> can be selected
                                </p>
                            </div>
        ...
        <ui-modal :show="openEditCollectionModal" @close="closeEditCollectionModal">
            ...
            <template #footer>
                ...
                <ui-button color="indigo-500" @click.native="editCollectionSubmit"> Save Collection </ui-button>
            </template>
        </ui-modal>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        addNewFieldSubmit() {
            ...
            if (this.editStatus) {
                axios.post("/admin/collections/fields/update/" + this.$route.params.project_id + "/" + this.$route.params.col_id + "/" + this.new_field.id, this.new_field).then(
                    (response) => {
                ...
                axios.post("/admin/collections/fields/store/" + this.$route.params.project_id + "/" + this.$route.params.col_id, this.new_field).then(
                    (response) => {
        ...
        editCollectionSubmit() {
            axios.post("/admin/collections/update/" + this.$route.params.project_id + "/" + this.$route.params.col_id, this.editCollectionData).then(
                (response) => {
