                    ...
                    <div class="mt-1 relative">
                        ...
                        <div v-if="field.type == 'media'" class="w-full">
                            <file-upload
                                ...
                                :maximum="
                                    field.options.media.type == '2' ? 4 : 1
                                "
                                class="w-full border-2 border-gray-300 rounded-md border-dashed hover:border-indigo-300 group"
                            >
                                <div
                                    class="mt-1 px-6 pt-5 pb-6 text-sm text-gray-400 group-hover:text-indigo-500"
                                >
                                    <svg
                                    ...
                                    <span
                                        ...
                                        v-if="field.options.media.type == '1'"
                                        >Select a file or drag and drop</span
                                    >
                                    <span
                                        class="cursor-pointer"
                                        v-else-if="
                                            field.options.media.type == '2'
                                        "
                                        >Select files or drag and drop</span
                                    >
                                    <p
                                        class="text-xs text-gray-500"
                                        v-if="upload_max_filesize !== null"
                                    >
    ...
    methods: {
        ...
        checkuploadstatus() {
            ...
            (this.form.fields || []).forEach((field) => {
                if (field.type === "media") {
                    if (
                        this.$refs["upload" + field.name] &&
                        this.$refs["upload" + field.name][0].active
                    ) {
                        check = false;
                    }
                }
        ...
        submitFormData() {
            ...
            (this.form.fields || []).forEach((field) => {
                if (field.type === "media") {
                    if (this.$refs["upload" + field.name]) {
                        this.$refs["upload" + field.name][0].files.forEach(
                            (file) => {
