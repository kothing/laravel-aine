...
@section('container')
    ...
    <div class="mt-6 flex items-center justify-between">
        <a href="{{ route('LaravelInstaller::environmentWizard') }}" class="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-600 shadow-sm transition hover:bg-slate-50">
        ...
        <a href="{{ route('LaravelInstaller::database') }}" class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-5 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
            {{ trans('installer_messages.confirm.install') }}
